...
Este proyecto presenta un caso práctico de **análisis de datos financieros aplicados a al Área de Tesorería de una Compañía Argentina Fintech**, abarcando el proceso completo de **preparación, análisis y visualización de información transaccional bancaria**.  
El objetivo es demostrar la capacidad de **Python** de generar reportes consolidados y visualizaciones ejecutivas que permiten facilitar la toma de decisiones financieras.
...
- **Distribución de montos con outliers destacados** (boxplots).
